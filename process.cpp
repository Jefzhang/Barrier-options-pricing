...
template<typename Tsde, typename Tstate>
Tstate weakEuler<Tsde, Tstate>::getState(){
        return this->state;
} 

template<typename Tsde, typename Tstate>
double weakEuler<Tsde, Tstate>::getStep(){
        return h;
}
...
template<typename Talgo, typename Tstate>
Tstate const & boundedPath<Talgo, Tstate>::getExitState(){
        return this->exit_state;
};

template<typename Talgo, typename Tstate>
usigned const & boundedPath<Talgo, Tstate>::getExitIndex(){
